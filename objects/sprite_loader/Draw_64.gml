...
if (demo == 0)
{
	...
	{
		var message_text = "The top scrolling surface is the parsed .ase exploded with all information expressed.\nAt the bottom, the image is flattened and layers with the visibility boolean set to false are not rendered.\nThe sprite in the middle of the screen is rendered dynamically, use left/right arrows to change animation.\n";
